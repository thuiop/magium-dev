...
function getAuxiliaryStatMapping() {
    ...
    stats_aux_mapping["v_available_points_aux"] = {
        "stat": "v_available_points",
        "field_id": "available_points",
        "value_span_id": "available_points_value"
    };
    stats_aux_mapping["v_strength_aux"] = {
        "stat": "v_strength",
        "field_id": "strength",
        "value_span_id": "strength_value"
    };
    stats_aux_mapping["v_toughness_aux"] = {
        "stat": "v_toughness",
        "field_id": "toughness",
        "value_span_id": "toughness_value"
    };
    stats_aux_mapping["v_agility_aux"] = {"stat": "v_agility", "field_id": "agility", "value_span_id": "agility_value"};
    stats_aux_mapping["v_reflexes_aux"] = {
        "stat": "v_reflexes",
        "field_id": "reflexes",
        "value_span_id": "reflexes_value"
    };
    stats_aux_mapping["v_hearing_aux"] = {"stat": "v_hearing", "field_id": "hearing", "value_span_id": "hearing_value"};
    stats_aux_mapping["v_perception_aux"] = {
        "stat": "v_perception",
        "field_id": "perception",
        "value_span_id": "perception_value"
    };
    stats_aux_mapping["v_ancient_languages_aux"] = {
        "stat": "v_ancient_languages",
        "field_id": "ancient_languages",
        "value_span_id": "ancient_languages_value"
    };
    stats_aux_mapping["v_combat_technique_aux"] = {
        "stat": "v_combat_technique",
        "field_id": "combat_technique",
        "value_span_id": "combat_technique_value"
    };
    stats_aux_mapping["v_premonition_aux"] = {
        "stat": "v_premonition",
        "field_id": "premonition",
        "value_span_id": "premonition_value"
    };
    stats_aux_mapping["v_bluff_aux"] = {"stat": "v_bluff", "field_id": "bluff", "value_span_id": "bluff_value"};
    stats_aux_mapping["v_magical_sense_aux"] = {
        "stat": "v_magical_sense",
        "field_id": "magical_sense",
        "value_span_id": "magical_sense_value"
    };
    stats_aux_mapping["v_aura_hardening_aux"] = {
        "stat": "v_aura_hardening",
        "field_id": "aura_hardening",
        "value_span_id": "aura_hardening_value"
    };
    stats_aux_mapping["v_magical_power_aux"] = {
        "stat": "v_magical_power",
        "field_id": "magical_power",
        "value_span_id": "magical_power_value"
    };
    stats_aux_mapping["v_magical_knowledge_aux"] = {
        "stat": "v_magical_knowledge",
        "field_id": "magical_knowledge",
        "value_span_id": "magical_knowledge_value"
    };
...
function initializeStats(stats_aux, stats_aux_mapping = null, reset_magic_stats = true) {
    ...
    for (const [stat_aux, stat_aux_value] of Object.entries(stats_aux)) {
        ...
        if (document.getElementById(stat_value_span_id) === null) {
            continue;
        }
...
function updateStat(stat, stat_aux_key, stat_field_id, stat_field_value_id) {
    ...
    if ((stat_aux_value >= stat_max) || (available_points <= 0)) {
        return;
    }
